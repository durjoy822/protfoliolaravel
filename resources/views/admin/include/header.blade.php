                    ...
                    <div class="dropdown-menu dropdown-menu-right notification">
                        ...
                        <ul class="noti-body">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="{{asset('adminAssets')}}/assets/images/user/avatar-1.jpg" alt="Generic placeholder image">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="{{asset('adminAssets')}}/assets/images/user/avatar-2.jpg" alt="Generic placeholder image">
                                    <div class="media-body">
