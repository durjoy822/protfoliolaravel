                ...
                <div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
                    ...
                    <div class="counter-wrap ftco-animate d-flex mt-md-3">
                        <div class="text">
                            ...
                            <p><a href="{{url('http://localhost/protfoliolaravel/public/admin/Cv/128727188.pdf')}}" class="btn btn-primary py-3 px-3">Download CV</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-md-6 text-center ftco-animate">
                    <p><a href="{{url('http://localhost/protfoliolaravel/public/admin/Cv/128727188.pdf')}}"" class="btn btn-primary py-4 px-5">Download CV</a></p>
                </div>
            </div>
            </div>
        </div>
